# -*- coding: utf-8 -*-
"""
Created on Tue Jul  8 17:41:34 2025
...
model = pickle.load(open(r"C:\Users\GANNOJU SHAHSANK\Downloads\NARESH IT\test.csv\LINEAR_REGRESSION_MODEL_PRACTICE.pkl", 'rb'))
